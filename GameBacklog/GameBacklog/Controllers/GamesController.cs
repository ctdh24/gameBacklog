...
namespace GameBacklog.Controllers
{
    ...
    {
        private readonly GameBacklogContext _context;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Game != null ? 
                          ...
                          Problem("Entity set 'GameBacklogContext.Game'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GameBacklogContext.Game'  is null.");
            }
            var game = await _context.Game.FindAsync(id);
            if (game != null)
            {
